...
parses ``artifacts/preprocessing/raw/dude/`` and writes, mirroring the LIT-PCBA test artifacts:
...
Example::
    ...
    python -m lattice_lab.preprocessing.run_dude \\
        ...
        --output-dir artifacts/preprocessing/processed/moses_dude
"""
...
def main() -> None:
    ...
    p.add_argument("--dude-dir", type=Path, default=Path("artifacts/preprocessing/raw/dude"),
                   help="Directory with one subfolder per DUD-E target.")
    p.add_argument("--output-dir", type=Path,
                   default=Path("artifacts/preprocessing/processed/moses_dude"))
